...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Error 404 - Robust Free Bootstrap Admin Template</title>
    <link rel="apple-touch-icon" sizes="60x60" href="{{ URL::asset('app-assets/css/bootstrap.css') }}../../app-assets/images/ico/apple-icon-60.png">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ URL::asset('app-assets/css/bootstrap.css') }}../../app-assets/images/ico/apple-icon-76.png">
    <link rel="apple-touch-icon" sizes="120x120" href="{{ URL::asset('app-assets/css/bootstrap.css') }}../../app-assets/images/ico/apple-icon-120.png">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ URL::asset('app-assets/css/bootstrap.css') }}../../app-assets/images/ico/apple-icon-152.png">
    <link rel="shortcut icon" type="image/x-icon" href="{{ URL::asset('app-assets/css/bootstrap.css') }}../../app-assets/images/ico/favicon.ico">
    <link rel="shortcut icon" type="image/png" href="{{ URL::asset('app-assets/css/bootstrap.css') }}../../app-assets/images/ico/favicon-32.png">
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('app-assets/css/pages/error.css') }}">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
  ...
  <body data-open="click" data-menu="vertical-menu" data-col="1-column" class="vertical-layout vertical-menu 1-column  blank-page blank-page">
    ...
    <div class="card-header bg-transparent no-border pb-0">
        ...
        <h3 class="text-uppercase text-xs-center"> {{trans('app.page_not_found')}} </h3>
    </div>
