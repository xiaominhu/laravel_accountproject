            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="main_menu">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="active"><a class="scroll-section" href="{{URL::to('/#home_banner')}}">home</a></li>
                        <li><a class="scroll-section" href="{{URL::to('/#about')}}">About us</a></li>
                        <li><a class="scroll-section" href="{{URL::to('/#features')}}">features</a></li>
                        <li><a class="scroll-section" href="{{URL::to('/#screenshots')}}">screenshots</a></li>
                        <li><a class="scroll-section" href="{{URL::to('/#download')}}">Download</a></li>
                        <li><a class="scroll-section" href="{{URL::to('/#contact')}}">contact</a></li>
                        <li><a class="scroll-section" href="{{URL::to('seller/login')}}">PROVIDER REGISTER/LOGIN</a></li>
                        <a class="dropdown-item language" href="#" data-lang="sa"> عربي </a>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
            </div>
