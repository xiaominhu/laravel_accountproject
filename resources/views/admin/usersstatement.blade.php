...
@section('admincontent')
 ...
 <div class="content-header row">
        ...
        <div class="content-body"><!-- stats -->
			...
			<div class = "row">
				<div class = "col-xs-4">
					<a  href = "{{URL::to('/admin/users/statement/export/')}}/{{$setting['id']}}"  class="btn btn-primary">
			...
			<div class = "row">
				<div class = "col-xs-4">
					...
					<form class="form-horizontal" method = "get" action="{{URL::to('/users/statement/')}}/{{$setting['id']}}">
