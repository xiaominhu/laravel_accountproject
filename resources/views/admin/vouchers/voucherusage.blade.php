...
@section('admincontent')
 <div class="content-header row">
		...
		<div class="row">
			...
			<div class = "row">
				<div class = "col-xs-4">
					<form class="form-horizontal" method = "get" action="{{route('voucherusage', $setting['id'])}}">	
				...
				<div class = "col-xs-4 float-xs-right">
						<form id="w0" class="form-inline float-xs-right"  action="{{route('voucherusage', $setting['id'])}}" method="get">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-striped">
									...
									<tbody>
								@if(count($voucherhistories))	
									@foreach($voucherhistories as $coupon)
										<tr>
