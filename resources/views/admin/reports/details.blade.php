												...
												<div class="col-md-6 offset-md-3">
													...
													<div class="table-responsive">
														...
														@if($transaction->type  == '4') 
															...
															<tr>
																<td> {{trans('app.posuser_email')}} </td>
																<td class="text-xs-right"> 
																	@if($transaction->posuer !== null)
																		{{$transaction->posuer->email}}
																	@endif
																</td>
															 </tr>
													@elseif($transaction->type  == '0') 
													...
													@elseif($transaction->type  == '1') 		
														<tr>
															<td> {{trans('app.bank_name')}} </td>
															<td class="text-xs-right"> 
																@if($transaction->deposit !== null)
																	{{$transaction->deposit->bank_name}}
																@endif
															</td>
														</tr>
														<tr>
															<td> {{trans('app.full_name')}} </td>
															<td class="text-xs-right"> 
																@if($transaction->deposit !== null)
																	{{$transaction->deposit->full_name}}
																@endif
															</td>
														</tr>
														<tr>
															<td> {{trans('app.date')}} </td>
															<td class="text-xs-right"> 
																@if($transaction->deposit !== null)
