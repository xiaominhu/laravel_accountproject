...
@section('admincontent')
 <div class="content-header row">
        ...
        <div class="content-body"><!-- stats -->
			...
			<div class = "row">
				<div class = "col-xs-4">
					<a  href = "{{URL::to('admin/notification/export')}}"  class="btn btn-primary">
								...
								<table class="table table-bordered table-striped">
									...
									@foreach($vehicles as $vehicle)
										<tr>
											...
											<td> 
												<select class="form-control" name = "not_status_{{$vehicle->id}}" >
													<option value = "0" <?php  if($vehicle->not_status == 0) echo "selected" ?> >  {{trans('app.not_en')}}   </option>
													<option value = "1" <?php  if($vehicle->not_status == 1) echo "selected" ?>>   {{trans('app.yes')}}      </option>
												</select>
											</td>
										</tr>
